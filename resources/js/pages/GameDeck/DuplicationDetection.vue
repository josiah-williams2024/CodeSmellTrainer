...
<template>
    ...
    <main class="flex min-h-screen justify-center bg-background p-2">
        ...
        >
            ...
            <section
                class="flex-1 overflow-y-auto rounded-lg border border-border bg-zinc-900"
            >
        ...
        <article
            v-else
            class="flex h-[85vh] w-full max-w-screen-2xl flex-col rounded-xl border border-border bg-card p-4 shadow-xl md:p-8"
        >
            <div
